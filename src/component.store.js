...
const Reducer = (state = {items: [], message : {type:"",content:""} , item : {} }, action )=>{
    ...
    switch(action.type){
        ...
        case Actions.ResponseSave: 
            return {...state,...{item:action.payload, message:{type:"success",content:"saved"}}}
        case Actions.ResponseDelete : 
            return {...state,...{message:{type:"success",content:"deleted"}}}    
        case Actions.ErrorDelete:
        case Actions.ErrorItem : 
        case Actions.ErrorSave: 
        case Actions.ErrorItems: 
            return {...state , ...{message:{type:"error", content:action.payload}}}
        default :
            return state 
        }
